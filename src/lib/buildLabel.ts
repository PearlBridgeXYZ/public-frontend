...
// constant to the next RC tag (RC5.29, RC5.29, ...). The footer renders
...
// clean grep target.
//
// Codebase is built off RC5.29 baseline. Next ship = RC5.29. Bump on
// every push, even tiny copy tweaks, per G's directive 2026-05-31.
export const BUILD_LABEL = "RC5.29";
